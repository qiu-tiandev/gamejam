...
class Renderer:
    def __init__(
        ...
        screen,
        Imagetextures: dict,
        TextTextures: dict[str, tuple[str, str, int, str]],
    ):  # enforce pre-rendering of textures
        self.screen = screen
        self.Imagetextures = {}
        self.TextTextures = {}
        self.visibility = {}
        ...
        console.sendInfo(
            f"Renderer initialized with {len(self.Imagetextures)} image textures and {len(self.TextTextures)} text textures.",
            __file__,
        )
    ...
    def createAndRenderSolidTexture(
        self,
        id: str,
        color: tuple[int, int, int],
        size: tuple[int, int],
    ...
    def ResizeTexture(self, id: str, size: list[int], crop: bool, save=False):
        ...
        if save:
            self.Imagetextures[id] = resized_surface
