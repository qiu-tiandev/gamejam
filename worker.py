...
util.setRenderer(Renderer(screen, {"chest": "Chest.png", "ground": "ground_1.png", "hotbar1": "Hotbar_1.png", "sky1": "Sky1.png", "general_items": "general_items.png", "guibase1": "gui_base_1.png"}, {"crafting_title": ("Crafting", "arial", 24, (255, 255, 255))}))
...
sample_world = World(200,themeColor=(102,51,153)) 
...
craftManager = CraftingManager(sample_world)
SpriteAnimation("general_items", (32,32), 17).save_frames("items")
...
inventory.addItem(util.getItemID("laser gun"), 1) #player spawns with 1 laser gun
inventory.addItem(util.getItemID("liquid fuel"), 1000000) #NOTE: REMOVE AFTER TESTING
while 1:
    util.SetDeltaTime()
    ...
    player.updateLasers(util.getDeltaTime())
    player.renderLasers()
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
                if event.button == 1:  # Left mouse button
                    player.shootLaser(pygame.mouse.get_pos(), inventory)
